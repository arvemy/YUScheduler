...
def api_generate_schedule():
    ...
    if excluded_courses:
        for course in excluded_courses:
            if not eligible_sections[course]:
                warnings.append(f"Course '{course}' was excluded: no valid sections available in the data.")
            else:
                warnings.append(f"Course '{course}' was excluded: all sections overlap with your blocked hours.")

    if not valid_courses:
        warnings.append("All selected courses were excluded. Please review your blocked hours or course selection.")
    ...
    if not valid_schedules:
        warnings.append("No valid schedule could be generated: all possible combinations have time conflicts or overlap with your blocked hours.")
